...
export declare class ChatApi {
    ...
    markDelivered(request?: MarkDeliveredRequest & {
        user_id?: string;
    ...
    uploadChannelFile(request: UploadChannelFileRequest & {
        type: string;
        id: string;
    ...
    uploadChannelImage(request: UploadChannelRequest & {
        type: string;
        id: string;
    ...
    queryFutureChannelBans(request?: {
